export function SearchBar() {
  return (
    <div className="w-full bg-white rounded-4xl shadow-lg border border-slate-100 p-5 flex flex-col md:flex-row items-center gap-4">
      ...
      <button className="w-full md:w-auto px-8 py-4 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-semibold shadow-lg hover:scale-[1.02] transition-all duration-300">
        Search Location
      </button>
    </div>
  )
