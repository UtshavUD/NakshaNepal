      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-slate-100">
        ...
        <div className="hidden lg:flex flex-col justify-center bg-linear-to-br from-red-600 to-red-700 text-white p-16 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-red-100 leading-relaxed max-w-lg mb-10">
              Continue exploring Nepal interactively through maps, geography,
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <p className="text-lg">Interactive Nepal Map</p>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-lg">Educational Geography Learning</p>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-lg">Search Locations Easily</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center p-8 md:p-16">
          <div className="w-full max-w-md">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                />
                  <button
                    type="button"
                    className="ml-80 text-nowrap text-sm text-red-500 hover:text-red-600"
                  >
                    Forgot Password?
                  </button>
              </div>
            ...
            <button className="w-full py-4 rounded-2xl border border-slate-300 hover:bg-slate-100 font-semibold transition-all duration-300">
              Continue as Guest
            </button>
